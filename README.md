External repository for Aixcoin Core related maintenance tools.
...
Aixcoin Core comes with several subtrees (c.f. https://github.com/aixcoin/aixcoin/tree/master/test/lint#git-subtree-checksh)
...
Sanity-check the DNS seeds used by Aixcoin Core.
...
Fast local copy of Aixcoin Core blockchain state.
