...
echo "Installing Aixcoin Core build deps"
...
git clone --depth=1 https://github.com/aixcoin-core/qa-assets.git
(
  cd qa-assets
...
git clone --depth=1 https://github.com/aixcoin/aixcoin.git
(
  cd aixcoin
