...
# Will produce a ../aixcoind.$1.stripped for binary comparison
...
# Set QT_RCC_SOURCE_DATE_OVERRIDE so that aixcoin-qt is deterministic
...
def parse_arguments():
    ...
    parser.add_argument('--executables', default='src/aixcoind', help='Comma-separated list of executables to build, default is "src/aixcoind"')
